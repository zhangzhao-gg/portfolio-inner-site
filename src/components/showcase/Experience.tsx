    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    但让我印象更深的是人。CEO 魏佳星活跃、朴实、专注、快速——他让我第一次真实感受到一个出色的人是什么样的。同事们也很好，整个氛围让我感受到了社会给我的第一份温暖。这段经历让我开始认真思考自己想成为什么样的人。
                </p>
            </div>
            <div style={styles.headerContainer}>
                <div style={styles.header}>
            ...
            <div className="text-block">
                <p>
                    因为对生命和性格的好奇，我想成为一名心理咨询师。我师从超个人心理学博士肖青，既是她的弟子，也是她的助理，跟随她系统学习了一年心理咨询。
                </p>
                <br />
                <p>
            ...
            <div className="text-block">
                ...
                <br />
                <p>
                    在校期间拿了不少全国级学科竞赛奖。我很喜欢打比赛，喜欢那种挑战和锻炼的感觉。大概就是从那时候开始，我在思考一个人如何才能成为一个了不起的人。
                </p>
                <br />
                <p>
